  ...
  id = {'BannerListTable'} >
    {
      ...
      < MessageColumn className = 'banner-message show-external-link' dangerouslySetInnerHTML = {
  {
    __html: banner.message
  }
}
  />
  < td > < StatusText
