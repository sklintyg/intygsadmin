...
const CreateDataExport = ({ handleClose, isOpen, onComplete, createUser, errorMessage, clearError }) => {
  ...
  return (
      <Modal isOpen={isOpen} size={'md'} backdrop={true} toggle={cancel}>
        ...
        <StyledBody>
          <FormGroup>
            <Label for='dataExportOrganizationNumber'><IaTypo04>{getMessage(`dataExport.create.organizationNumber`)}</IaTypo04></Label>
            <Input
          ...
          <FormGroup>
            <Label for='dataExportPersonalNumber'><IaTypo04>{getMessage(`dataExport.create.personalNumber`)}</IaTypo04></Label>
            <Input
          ...
          <FormGroup>
            <Label for='dataExportEmail'><IaTypo04>{getMessage(`dataExport.create.email`)}</IaTypo04></Label>
            <Input
              id='dataExportEmail'
              value={newDataExport.email}
              maxLength={200}
          ...
          <FormGroup>
            <Label for='dataExportTelephoneNUmber'><IaTypo04>{getMessage(`dataExport.create.telephoneNUmber`)}</IaTypo04></Label>
            <Input
          ...
          <FormGroup>
            <Label for='dataExportExportDate'><IaTypo04>{getMessage(`dataExport.create.exportDate`)}</IaTypo04></Label>
            <Input
