...
public class PublicApiController {
  ...
  public static final String SESSION_STAT_REQUEST_MAPPING =
      PUBLIC_API_REQUEST_MAPPING + SESSION_STATUS_PING;
  ...
  private SessionStateResponse createStatusResponse(HttpServletRequest request) {
    ...
    return new SessionStateResponse(
        new SessionState(session != null, isAuthenticated, secondsLeft == null ? 0 : secondsLeft));
  }
