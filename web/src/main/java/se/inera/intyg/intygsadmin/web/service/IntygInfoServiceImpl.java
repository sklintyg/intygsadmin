...
public class IntygInfoServiceImpl implements IntygInfoService {
  ...
  public IntygInfoServiceImpl(
      IntygInfoPersistenceService intygInfoPersistenceService,
      IntygInfoMapper intygInfoMapper,
      UserService userService,
      ITIntegrationRestService itIntegrationRestService,
      WCIntegrationRestService wcIntegrationRestService) {
  ...
  public Optional<IntygInfoDTO> getIntygInfo(String intygId) {
    ...
    events.sort(
        Comparator.comparing(
                IntygInfoEvent::getDate, Comparator.nullsFirst(Comparator.naturalOrder()))
            .reversed());
