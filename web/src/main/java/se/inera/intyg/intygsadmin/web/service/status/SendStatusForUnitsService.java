...
@Service
public interface SendStatusForUnitsService {

    Integer send(SendStatusForUnitsRequestDTO request);

    CountStatusesDTO count(CountStatusesForUnitsRequestDTO request);
