...
public class CustomLogoutSuccessHandler extends OidcClientInitiatedLogoutSuccessHandler {
  ...
  public void onLogoutSuccess(
    ...
    if (authentication == null
        || !(authentication.getPrincipal() instanceof IntygsadminUser intygsadminUser)) {
  ...
  private void logoutSithsUser(
      HttpServletRequest request, HttpServletResponse response, IntygsadminUser user)
      throws IOException {
    ...
    final var idpEndSessionEndpoint =
        clientRegistration
            .getProviderDetails()
    ...
    final var uriBuilder =
        UriComponentsBuilder.fromUriString(idpEndSessionEndpoint)
