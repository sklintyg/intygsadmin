...
public class TerminationRestServiceStub implements TerminationRestService {
  ...
  private boolean requiresPackageReExport(String status) {
    return "Uppladdat".equals(status)
        || "Notifiering skickad".equals(status)
        || "Påminnelse skickad".equals(status);
  }
  ...
  private void createStubData() {
    ...
    dataExportEntity10.setCreated(
        LocalDateTime.now().minusDays(1L).minusHours(2L).minusMinutes(2L));
    ...
    dataExportEntity11.setCreated(
        LocalDateTime.now().minusDays(2L).minusHours(1L).minusMinutes(1L));
    ...
    dataExportEntity12.setCreated(
        LocalDateTime.now().minusDays(2L).minusHours(1L).minusMinutes(2L));
    ...
    dataExportEntity13.setCreated(
        LocalDateTime.now().minusDays(2L).minusHours(2L).minusMinutes(1L));
    ...
    dataExportEntity14.setCreated(
        LocalDateTime.now().minusDays(2L).minusHours(2L).minusMinutes(2L));
